 ...
 */
/**
 * @typedef {function(LoggingEntry)} LoggingCallback
 */
...
class Connection {
  constructor(opts) {
    ...
    if (opts.bucketName) {
      ...
      connStr += '/' + opts.bucketName + "?config_node_timeout=9";
    }

    console.log("MFL-Couchbase : Creating connection to "+connStr);
